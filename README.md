...
**Note - Synthetic data generated by Synthetic Patient Population Simulator is provided as part of the lab but you have the flexibility to use your own data with this reference architecture and modify scripts in `glue_scripts` directory to generate training data set. If you want to generate your own data with this tool, follow instructions as mentioned here [Optional -Generate New Data Set](OPTIONAL.md)**
